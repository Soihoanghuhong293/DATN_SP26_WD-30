...
import { Button, Card, Col, Collapse, Form, Input, InputNumber, message, Row, Select, Space, Spin, Typography, Upload } from 'antd';
            ...
            <Col xs={24} lg={14}>
              ...
              <Card className="rounded-2xl shadow-sm border border-gray-100 mb-6" bordered={false}>
                ...
                <div className="text-sm text-gray-500 mb-4">
                  Mỗi ngày được thu gọn để dễ nhìn. Bấm vào tiêu đề “Ngày …” để mở/chỉnh sửa.
                </div>
                          ...
                          <div className="bg-gray-50 border border-gray-100 rounded-xl p-4">
                            ...
                            <Row gutter={[16, 12]}>
                              <Col xs={24} md={8}>
                                ...
                                >
                                  <Input size="middle" className="rounded-lg" placeholder="VD: Đà Nẵng - Bán đảo Sơn Trà" />
                                </Form.Item>
                              </Col>
                              <Col xs={24} md={16}>
                                <Form.Item
                              ...
                              <Col span={24}>
                                <Form.Item {...restField} name={[name, 'ticket_ids']} label="Vé trong ngày" style={{ marginBottom: 0 }}>
                                  <Select
                                    mode="multiple"
                                    allowClear
                                    showSearch
